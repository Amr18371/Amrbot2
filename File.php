...
$setengss = $move["move"]["20"]; #دخول
$cccoin = $move["move"]['25'];  #عموله 
$uu = $move["move"]['10']; #هديه
$Less = $move["move"]['50']; #اقل حد للرشق
$myy = $move["move"]['@TTT_E'] ; #تواصل
$myyy = $move["move"]['https://t.me/sorsmafia']; #معلومات مساعدة
$mmyyy = $move["move"]['https://t.me/YYX9X']; #قناة اثباتات
$number = $move["bob"]["$chat_id"]["Trans"]; #عدد التحويلات
$setengss1 = $move["bob"]["$chat_id"]["setengss1"]; #عدد مشاركات
$uuu = $move["bob"]["$chat_id"]["10"]; #عدد الهدايا
$uuuu = $move["bob"]["$chat_id"]["10"]; #عدد هدايا
...
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
[['text'=>"المطور",'url'=>"https: t. me/YYX9X"]],
...
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
 [['text'=>"قناة البوت ✔️",'url'=>"https: t. me/YYX9X"]],
 [['text'=>"المطور",'url'=>"https: t. me/TTT_E"]],
[['text'=>"رجوع 🔙",'callback_data'=>"back1"]],
    ] 
   ])
  ]);
...
$sar = $text * 0.2;
bot('sendmessage',['chat_id'=>$mmy,'text'=>"
*~ عملية رشق جديدة ✅
